...
const blogs = [
  {
    ...
    author: "Tim Winosa",
    tags: ["Web Development", "SEO", "Business Growth"],
  ...
  },
  {
    ...
    author: "Tim Winosa",
    tags: ["Mobile App", "Flutter", "Startup"],
    image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&q=80&w=800",
    views: 1560
  },
  {
    title: "SEO 101: Cara Masuk Halaman Pertama Google di Tahun 2026",
    slug: "seo-101-halaman-pertama-google",
    excerpt: "Algoritma pencarian Google terus berkembang dengan AI Overviews. Ketahui teknik On-Page dan Off-Page SEO terbaru yang wajib diterapkan di website perusahaan Anda.",
    content: "<h2>Content is Still King, tapi Context is Queen</h2><p>Google kini lebih memprioritaskan niat pengguna (User Intent) daripada sekadar kata kunci yang diulang-ulang (keyword stuffing).</p><h3>Core Web Vitals</h3><p>Kecepatan loading website Anda sangat krusial. Pastikan skor Lighthouse Anda di atas 90 untuk metrik performa.</p><h3>Backlink Berkualitas</h3><p>Mendapatkan tautan dari website terpercaya jauh lebih baik daripada ribuan tautan dari situs spam.</p>",
    author: "Tim Winosa",
    tags: ["SEO", "Digital Marketing"],
    image: "https://images.unsplash.com/photo-1571498108428-f68285906da7?auto=format&fit=crop&q=80&w=800",
    views: 3400
  },
  {
...
async function seedBlogs() {
  try {
    ...
    console.log(`Inserting ${blogs.length} SEO-optimized blogs...`);
    await Blog.insertMany(blogs);
    
    console.log("✅ Successfully seeded 20 blogs with SEO metadata!");
    process.exit(0);
  } catch (error) {
