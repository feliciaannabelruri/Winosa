  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        <div className="absolute right-[10%] top-[20%] w-[300px] h-[300px] bg-white/10 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="relative z-20 w-full">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          <div className="max-w-[620px] ml-auto text-white text-right">
            ...
            <FadeUp>
              <h1
                className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight tracking-tight"
            ...
            <FadeUp delay={0.2}>
              <p
                className="mt-6 text-sm sm:text-base md:text-lg text-white/90 leading-relaxed font-body max-w-[540px] ml-auto"
