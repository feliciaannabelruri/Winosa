...
import { Plus, Search, Trash2, Edit2, Image, Eye, Layout, BookOpen, Award } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { portfolioService } from '../services/portfolioService';
import PortfolioHeroEditor from './PortfolioHeroEditor';
import PortfolioExplanationEditor from './PortfolioExplanationEditor';
import PortfolioBridgeEditor from './PortfolioBridgeEditor';
...
const PortfolioPage: React.FC = () => {
  ...
  const [tab, setTab] = useState<'portfolio' | 'hero' | 'explanation' | 'bridge'>('portfolio');
      ...
      <div className="overflow-x-auto pb-1 -mb-1">
        <div className="inline-flex items-center gap-1 bg-white border border-gray-200 rounded-full px-2 py-1.5 shadow-sm min-w-max">
          {([
            ...
            { id: 'bridge',      label: 'Our Belief',  icon: Award    },
