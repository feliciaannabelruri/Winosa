    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 italic">Kelola studi kasus dan proyek Winosa</p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-gray-400 text-sm">Tidak ada portfolio yang ditemukan</div>
      ) : (
              ...
              <div className="h-48 flex-shrink-0 bg-gray-50 flex items-center justify-center relative">
                {portfolio.thumbnail || portfolio.image ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-300 italic">Belum ada thumbnail</p>
                  </div>
                )}
